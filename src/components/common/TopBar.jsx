...
const SOCIAL_LINKS = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/algorithmtechsolutions',
    color: '#E1306C',
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/algorithmtechsolutions',
    color: '#1877F2',
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@algorithmtechsolutions',
    color: '#FF0000',
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/algorithm-tech-solutions',
    color: '#0A66C2',
  ...
  {
    label: 'WhatsApp',
    href: 'https://wa.me/918436963334?text=Hi%2C%20I%27m%20interested%20in%20IT%20Training%20at%20Algorithm%20Tech.',
    color: '#25D366',
...
export default function TopBar() {
  return (
    <div
      className="text-slate-200 text-[10px] sm:text-[11px] font-semibold"
    ...
    >
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 flex items-center justify-between gap-2 py-1.5 sm:py-2">
        ...
        <div className="flex items-center gap-0">
          <span className="text-slate-400 text-[9px] sm:text-[10px] mr-1.5 hidden sm:inline tracking-widest uppercase font-bold">
            Follow Us
          </span>
          {SOCIAL_LINKS.map((s) => (
            <a
              ...
              aria-label={s.label}
              title={s.label}
              className="w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center rounded-lg transition-all duration-200 hover:scale-110 active:scale-95"
              style={{ color: s.color }}
